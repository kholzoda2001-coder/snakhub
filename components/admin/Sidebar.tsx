...
const NAV = [
  ...
  { href: '/admin/companies', icon: '🤝', label: 'Wholesale' },
  ...
  return (
    <aside className={`admin-sidebar ${isOpen ? 'open' : ''}`}>
      ...
      <nav className="admin-nav">
        ...
        <Link href="/" target="_blank" rel="noopener noreferrer" className="nav-external" title={isCollapsed ? 'View Live Store' : undefined}>
