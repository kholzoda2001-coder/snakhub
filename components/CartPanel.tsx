...
export default function CartPanel({ cart, isCartOpen, toggleCart, removeFromCart, updateQty }: {
  cart: CartItem[];
  isCartOpen: boolean;
  toggleCart: () => void;
              ...
              <div key={item.id} className="cart-item">
                ...
                <div className="ci-info">
                  ...
                  <div className="ci-row">
                    <div className="ci-price">{formatMoney(item.price * item.qty)} {t('product.currency')}</div>
